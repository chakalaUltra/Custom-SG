...
const GUIDES: Record<string, Guide> = {
  ...
  mute: {
    ...
    example: "v!mute @JohnDoe 1h Disruptive behavior in voice",
  ...
  ban: {
    ...
    example: "v!ban @JohnDoe Repeated severe rule violations",
  ...
  unban: {
    ...
    example: "v!unban 123456789012345678 Appeal accepted",
  ...
  kick: {
    ...
    example: "v!kick @JohnDoe Breaking server rules",
  },
  role: {
    category: "role",
    emoji: E.userConfig,
  ...
  rank: {
    ...
    usage: "v!rank <@user> <stage> <midstage> <extrastage>",
    args: [
    ...
    example: "v!rank @JohnDoe 3 High Stable",
